...
func readRowsFromSheet(Worksheet *xlsxWorksheet, file *File, sheet *Sheet) ([]*Row, []*Col, int, int) {
	...
	// there's issue on xlsx generated by libreoffice calc
	// sometimes it generate "wrong" dimension ref
	// eg. sheet with 8 columns and 34 rows will have dimension ref "1:34"
	// workaround: ignore dimension ref for now
